...
export namespace BaseDI.Community.Chapter.Page.Web_Development_10 {
    export class Page_10_5_Process_StorySetting_12_3_1_0 extends aClass_Programming_ScriptPage_12_2_1_0.BaseDI.Community.Programming.Abstract_1.aClass_Programming_ScriptPage_12_2_1_0 {
        //#region 1. Assign
        ...
        private _storedProcessRequestFileName: string = "LocalFile_Director_Of_Advertising_Chapter_1_1_Page_10_CreateAdvertisement_Handler_1_0 ";
        ...
        public async Action(): Promise<object> {
            ...
            let storedProcessRequestDeveloperLoggingStartUpProcessInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0 = (this._storedInputs.Parameters.getValue("parameterProcessRequestExtraData")?.KeyValuePairs["storedProcessRequestDeveloperLoggingInputs"] ? this._storedInputs.Parameters.getValue("parameterProcessRequestExtraData")?.KeyValuePairs["storedProcessRequestDeveloperLoggingInputs"] : null);
            ...
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Director_Of_WebDevelopment_Chapter_12_3_Page_10_OutputAffiliateScreen_Handler_1_0 -> Page_10_5_Process_StorySetting_12_3_1_0.cs");
            ...
            //#region CONVERT json to html

            try {
                //#region IDEAL CASE - USE baseDI converter

                storedOutputResponseData = await Extension_Director_Of_WebDevelopment_Chapter_12_3_Page_0_GoalHelper_Handler_1_0.BaseDI.Community.Web_Development.Extensions_0.Extension_Director_Of_WebDevelopment_Chapter_12_3_Page_0_GoalHelper_Handler_1_0.Step_0_0_Framework_Convert_HtmlToJSON_1_0(this._storedInputs);
                ...
                if (storedProcessRequestDeveloperMode) {
                    ...
                    //2. PROCESS
                    storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequest3WordDescription", "FAILED rendering web page");
