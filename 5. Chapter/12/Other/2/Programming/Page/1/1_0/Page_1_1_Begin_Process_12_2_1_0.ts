...
{
    export class Page_1_1_Begin_Process_12_2_1_0 extends aClass_Programming_ScriptPage_12_2_1_0.BaseDI.Community.Programming.Abstract_1.aClass_Programming_ScriptPage_12_2_1_0
    {
        //#region 1. Assign
        ...
        public async Action(): Promise<object>
        {
            ...
            this._storedInputs.Parameters.setValue("parameterProcessRequestName", null);
            ...
            try
            {
                if (this.StorylineDetails == null || Object.keys(this.StorylineDetails).length == 0)
                {
                    ...
                    storedOutputResponseData = await ExecuteOutputResponse(this._storedInputs);
