...
{
    export class Page_2_1_Begin_Process_12_2_1_0 extends aClass_Programming_ScriptPage_12_2_1_0.BaseDI.Community.Programming.Abstract_1.aClass_Programming_ScriptPage_12_2_1_0
    {
        //#region 1. Assign
        ...
        private Step_1_0_Framework_Store_JSONStringPlaceHolder_1_0(parameter_BaseDI_JSONDataSchema: any)
        {
            ...
            this._storedProcessRequestTracker = this._storedProcessRequestTracker;
        ...
        private Step_2_0_Framework_Convert_JSONStringPlaceHolderIntoAppSettings_1_0()
        {
            ...
            try
            {
                ...
                if (this._storedJSONKeyPlaceHolderName) {
                    ...
                    //SET SEARCH DATASET                 
                    let jsonDataSet: any = storylineDetails; //storylineDetails = C:\Programming\0.3.BaseDI.Community.QuickStart.Templates\2. Data Movement\ARM Templates\12\Other\2\Programming\Template\2\1_0\State_Director_Of_Programming_Chapter_12_2_Page_1_Request_Handler_1_0.json
                    if (storylineDetails_Parameters) {
                        jsonDataSet = storylineDetails_Parameters;

                        filterJSONDataSetBy = null;
                    } //storylineDetails_Parameters = C:\Programming\0.3.BaseDI.Community.QuickStart.Templates\2. Data Movement\ARM Templates\12\Other\2\Programming\Template\2\1_0\State_Director_Of_Programming_Chapter_12_2_Page_1_Request_Handler_1_0-P1_0.json
