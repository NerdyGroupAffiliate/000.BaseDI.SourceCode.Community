...
{
    public class Page_P_S_Process_StoryExperiences_G_N_V_V : aClass_Programming_ScriptPage_12_2_1_0
    {
        #region 1. Assign
        ...
        public Page_P_S_Process_StoryExperiences_G_N_V_V(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
