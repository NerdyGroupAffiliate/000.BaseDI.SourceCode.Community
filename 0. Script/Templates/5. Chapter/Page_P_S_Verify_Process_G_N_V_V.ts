...
export namespace BaseDI.Community.Chapter.Page.NICHE_X {
    export class Page_P_S_Verify_Process_G_N_V_V extends aClass_Programming_ScriptPage_12_2_1_0.BaseDI.Community.Programming.Abstract_1.aClass_Programming_ScriptPage_12_2_1_0 {
        //#region 1. Assign
        ...
        public async HandleDefaults(): Promise<any> {
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<boolean> => {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "{DirectorOrExperienceName} -> Page_P_S_Verify_Process_G_N_V_V.ts");
