...
namespace BaseDI.Community.Chapter.Page.NICHE_X
{
    public class Page_P_S_Process_StoryCharacters_G_N_V_V : aClass_Programming_ScriptPage_12_2_1_0
    {
        ...
        public override async Task<JObject> Action()
        {
            ...
            storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "{DirectorOrExperienceName} -> Page_P_S_Process_StoryCharacters_G_N_V_V.cs");
