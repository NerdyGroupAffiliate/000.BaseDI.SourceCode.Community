...
//using BaseDI.Community.Script.{NN}_{X};
...
//using ChapterPage = BaseDI.Community.Chapter.Page.{NN}_{X};
...
namespace BaseDI.Community.Director.NICHE_X
{
    public class Director_Of_NICHE_Chapter_G_N_Page_P_DESCRIPTION_Handler_V_V : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        #region 1. Assign
        ...
        public Director_Of_NICHE_Chapter_G_N_Page_P_DESCRIPTION_Handler_V_V(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "Director_Of_NICHE_Chapter_G_N_Page_P_DESCRIPTION_Handler_V_V.cs");
            ...
            Use_DesignPattern_Builder_Chapter_G_N_Page_P storedProcessRequestHandler_UsingBuilderPattern = null;
            ...
            try
            {
                ...
                storedProcessRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_G_N_Page_P(_storedInputs);
    ...
    internal class Use_DesignPattern_Builder_Chapter_G_N_Page_P
    {
        #region 1. Assign
        ...
        internal Use_DesignPattern_Builder_Chapter_G_N_Page_P(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        internal async Task<JObject> Action()
        {
            ...
            storedProcessRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_G_N_Page_P_V_V(_storedInputs);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_G_N_Page_P_V_V : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        #region 1. Assign
        ...
        private HttpRequest _storedProcessRequestServerHTTPRequestInstance = null;
        ...
        private Func<SingleParmPoco_12_2_1_0, JObject> StartUpCallBack = null;

        #endregion

        #region 2. Ready

        internal Implement_DesignPattern_Builder_Chapter_G_N_Page_P_V_V(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
