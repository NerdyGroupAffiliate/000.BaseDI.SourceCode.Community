...
namespace BaseDI.Community.Experience.HUMANSENSE.NICHE_X
{
    public class Experience_The_HUMANSENSE_Chapter_G_N_Page_P_DESCRIPTION_Handler_V_V : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        #region 1. Assign
        ...
        public Experience_The_HUMANSENSE_Chapter_G_N_Page_P_DESCRIPTION_Handler_V_V(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "Experience_The_HUMANSENSE_Chapter_G_N_Page_P_DESCRIPTION_Handler_V_V.cs");
