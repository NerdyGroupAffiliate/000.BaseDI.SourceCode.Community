...
import * as SettingWebsite from "../../3. Setting/9/Software/12/Other/3/Web Development/Location/0/1_0/Setting_Of_WebDevelopment_Chapter_12_3_Page_0_StoreHtmlCssScript_DataContract_1_0";

//#endregion

//#endregion

export namespace BaseDI.Community.Snippets {
    export class Actions {
        ...
        public async Action_1_0(): Promise<any> {
            ...
            let storedInputRequestExampleJSON: SettingWebsite.BaseDI.Community.BackEnd.Setting.Location.Web_Development.HtmlSection =
            {
