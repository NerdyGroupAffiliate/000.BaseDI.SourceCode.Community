...
namespace BaseDI.Community.Snippets
{
    public class Actions
    {
        ...
        #region SOLUTION 1 - FILE MANAGER EXAMPLE - HOW TO CONVERT JSON TO A GENERIC LIST OF FILE NAMES

        public async Task Action_1_0() {
            #region 1. INPUTS
