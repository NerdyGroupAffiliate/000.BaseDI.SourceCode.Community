...
export namespace BaseDI.Community.Programming.Extensions_1
{
    export class Extension_Director_Of_Programming_Chapter_12_2_Page_1_ControlRequest_Handler_1_0
    {      
        constructor() {
