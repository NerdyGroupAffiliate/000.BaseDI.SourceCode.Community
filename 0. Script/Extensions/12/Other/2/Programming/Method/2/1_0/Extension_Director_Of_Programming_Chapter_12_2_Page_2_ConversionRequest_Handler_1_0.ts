...
//import * as importedPixiJS from "pixi-js";
...
export namespace BaseDI.Community.Programming.Extensions_2 {
    export class Extension_Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0 {
        constructor()
        {
            //#region 1. INPUTS
        ...
        //Cartoonize Filter
        public static async Step_X_X_Framework_Convert_ImageToFilteredImage_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<any> {
            //#region 1. INPUTS
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0) => {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestMethodName", "Step_X_X_Framework_Convert_ImageToFilteredImage_1_0 -> ValidateInputs");
                ...
                if (parameterInputs != null || parameterInputs != undefined || parameterInputs.Parameters != null && parameterInputs.Parameters != undefined) {
                    ...
                    //3. OUTPUTS
                    if (!parameterInputs.Parameters.containsKey("parameterOutputResponseFileName")) {
                        storedOutputResponseMessage += "***parameterOutputResponseFileName*** cannot be blank or empty.\n"
                        storedProcessRequestMistakeMade = true;
                    }
            ...
            let storedInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0 = new SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0;
            ...
            //2. PROCESS
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequest3WordDescription", "EXECUTING image to filtered image conversion");
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestSettings", storedProcessRequestTracker["storedProcessRequestSettings"]);
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestTracker", storedProcessRequestTracker);
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Extension_Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0.ts");
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestMethodName", "Step_X_X_Framework_Convert_ImageToFilteredImage_1_0");
            ...
            //#region MEMORIZE output file details

            let storedOutputResponseFileName: string = parameterInputs.Parameters.getValue("parameterOutputResponseFileName");
            ...
            //#region EXECUTE convert image to filtered image

            //#region IDEAL CASE - USE baseDI converter

            try {
                //#region A. CONVERT image to pixi object
                ...
                try {
                    ...
                    throw new Error("converting xxx to xxx");
                }

                //#endregion

                //#region B. CONVERT pixi object to pixels
                ...
                //#region C. CONVERT pixels to border pixels
                ...
                //#region D. CONVERT pixels to inner pixels
        ...
        public static async Step_X_X_Framework_Convert_CssToJson_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<any> {
            //#region 1. INPUTS
        ...
        public static async Step_X_X_Framework_Convert_HtmlToJson_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<any> {
            //#region 1. INPUTS
