...
namespace BaseDI.Community.Script.Web_Development.Extensions_13
{
                                ...
                                foreach (string element in prop.properyValues)
                                {
                                    if (element.Contains("url"))
                                    {
                                        ...
                                        if (File.Exists(filepath))
                                        {
                                            ...
                                            var shortDirName = fileDirName.Replace("C:\\Programming\\999.0.3.BaseDI.Community.QuickStart.Templates\\", "");
