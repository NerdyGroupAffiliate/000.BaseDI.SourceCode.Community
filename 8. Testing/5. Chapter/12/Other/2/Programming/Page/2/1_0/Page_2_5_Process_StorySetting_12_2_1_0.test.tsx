...
//5. CHAPTER
import * as ChapterPage_Page_2_5_Process_StorySetting_12_2_1_0 from "../../../../../../../../../5. Chapter/12/Other/2/Programming/Page/2/1_0/Page_2_5_Process_StorySetting_12_2_1_0";
...
const ExecuteConversionRequest = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<any> => {
    ...
    let storedProcessRequestConverter: ChapterPage_Page_2_5_Process_StorySetting_12_2_1_0.BaseDI.Community.Chapter.Page.Programming_2.Page_2_5_Process_StorySetting_12_2_1_0;
    ...
    storedProcessRequestConverter = new ChapterPage_Page_2_5_Process_StorySetting_12_2_1_0.BaseDI.Community.Chapter.Page.Programming_2.Page_2_5_Process_StorySetting_12_2_1_0(parameterInputs);

    storedOutputResponseData = await storedProcessRequestConverter.Action();
...
describe('Conversion Test', () => {
    test.only('1. Conversion Test - Convert HTML to JSON', async () =>
    {
        //#region 1. INPUTS
        ...
        //1. INPUTS
        storedInputs.Parameters.setValue("parameterInputRequestActionName", Action_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.Action_12_2_1_0._12_3_WEB_DEVELOPMENT_Server_Process_HtmlToJsonConversion_Request_1_0);
