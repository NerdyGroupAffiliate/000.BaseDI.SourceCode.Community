...
export const Action = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<any> => {
    //#region 1. INPUTS
    ...
    let storedProcessRequestDataRepository: ChapterPage_Page_2_1_Begin_Process_12_2_1_0.BaseDI.Community.Chapter.Page.Programming_2.Page_2_1_Begin_Process_12_2_1_0;

    //#endregion

    //#region DEFINE output variables

    let storedOutputResponseData: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0 = null;
    ...
    if (!parameterInputs.Parameters.containsKey("parameterProcessRequestCentralizedStorer") || parameterInputs.Parameters.getValue("parameterProcessRequestCentralizedStorer") == undefined) {
        //parameterInputs.Parameters.setValue("parameterProcessRequestCentralizedStorer", new Implement_DesignPattern_Factory_Storer_12_2_1_0.BaseDI.Community.Story.Programming_0.Implement_DesignPattern_Builder_Chapter_12_2_1_0(parameterInputs));
    }
    ...
    if (!parameterInputs.Parameters.containsKey("parameterProcessRequestDataStorylineDetails") || parameterInputs.Parameters.getValue("parameterProcessRequestDataStorylineDetails") == undefined) {
        ...
        storedProcessRequestDataRepository = new ChapterPage_Page_2_1_Begin_Process_12_2_1_0.BaseDI.Community.Chapter.Page.Programming_2.Page_2_1_Begin_Process_12_2_1_0(parameterInputs);
        storedProcessRequestDataRepository.Repository = new LocalFile_Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0.BaseDI.Community.State.Programming_2.LocalFile_Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0(parameterInputs);        
...
const Action_Factory_Start = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0> => {
...
const Action_Factory_Start_12_3_WebDevelopment = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0> => {
    //#region 1. INPUTS
    ...
    //1. INPUTS
    parameterInputs.Parameters.setValue("parameterInputRequestActionName", Action_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.Action_12_2_1_0._12_3_WEB_DEVELOPMENT_Server_Process_HTTP_Request_1_0);
...
const Action_Factory_End = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<SingleParmPoco_12_2_1_0.BaseDI.Community.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0> => {
    //#region 1. INPUTS
    ...
    let storedProcessRequestLocalCacheDataRepository: ChapterPage_Page_2_1_Begin_Process_12_2_1_0.BaseDI.Community.Chapter.Page.Programming_2.Page_2_1_Begin_Process_12_2_1_0;
    ...
    storedProcessRequestLocalCacheDataRepository = new ChapterPage_Page_2_1_Begin_Process_12_2_1_0.BaseDI.Community.Chapter.Page.Programming_2.Page_2_1_Begin_Process_12_2_1_0(parameterInputs);
    storedProcessRequestLocalCacheDataRepository.Repository = new LocalFile_Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0.BaseDI.Community.State.Programming_2.LocalFile_Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0(parameterInputs);
